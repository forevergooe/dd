...
sh_ver="1.0.1"
github="raw.githubusercontent.com/forevergooe/dd/master"
...
if [[ "${country}" == "国外" ]]; then
	...
	if [[ "${os}" == "c" ]]; then
		country="--mirror http://mirrors.aliyun.com/centos/"
	elif [[ "${os}" == "u" ]]; then
		country="--mirror http://mirrors.aliyun.com/ubuntu/"
	elif [[ "${os}" == "d" ]]; then
		country="--mirror http://mirrors.aliyun.com/debian/"
	fi
fi
