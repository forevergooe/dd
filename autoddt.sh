...
read N
case $N in
  1) echo "Password: MoeClub.org" ; read -s -n1 -p "Press any key to continue..." ; bash InstallNET.sh --ip-addr $MAINIP --ip-gate $GATEWAYIP --ip-mask $NETMASK -dd 'https://www.mikcool.site/files/dd/centos/CentOS_7.X_NetInstallation.vhd.gz' ;;
